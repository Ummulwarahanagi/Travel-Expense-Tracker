...
import pandas as pd
from google_sheet_utils import (connect_sheet,add_ex_gsheet,load_ex_gsheet,delete_expense,update_expense,set_budget,get_budget)
...
with st.sidebar.form("add_expense"):
    ...
    category = st.selectbox(
        "Category", ["Flights", "Hotels", "Food", "Transport", "Miscellaneous"]
    )
